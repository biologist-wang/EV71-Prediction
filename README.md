# EV71-Prediction
The open-source of Physicochemical Fingerprinting Reveals Convergent Evolutionary Determinants of Enterovirus A71 Neurovirulence Through Integrative Machine Learning and Structural Analysis.

- Raw_data_sequences——Raw dataset of 15,000 entries
- Master_Dataset——Matrix construction and complete training data
- training_data——Filtered files for preliminary training used to build the matrix
